...
void Vsinegen::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+4,(vlTOPp->dout1),8);
        tracep->chgCData(oldp+5,(vlTOPp->dout2),8);
        tracep->chgCData(oldp+6,(vlTOPp->sinegen__DOT__addr1),8);
        tracep->chgCData(oldp+7,(vlTOPp->sinegen__DOT__addr2),8);
    }
}
